      ...
      {tracks.map(track => (
        <div
          ...
          style={{
            ...
            padding:    '10px 16px',
            cursor:     'pointer',
            color:      track.selected ? 'var(--color-text-primary)' : 'color-mix(in srgb, var(--color-text-primary) 60%, transparent)',
        ...
        >
          ...
          <span style={{
            ...
            height:       6,
            borderRadius: '50%',
            background:   track.selected ? 'var(--color-text-primary)' : 'transparent',
